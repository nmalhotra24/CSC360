...
To run the file named assign2.c, type make on the command line and this will invoke the makefile that will compile the file assign2.c into an executable file PQS. To execute the executable file PQS, type ./PQS input.txt on the command line.